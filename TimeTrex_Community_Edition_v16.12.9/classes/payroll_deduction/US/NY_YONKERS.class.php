...
class PayrollDeduction_US_NY_YONKERS extends PayrollDeduction_US_NY {
	...
	*/
	...
	var $district_income_tax_rate_options = [
			...
			20220101 => [
					10 => [ //This has 12 brackets, less than married.
							...
							[ 'income' => 5000000, 'rate' => 10.45, 'constant' => 78779 ],
					...
					20 => [ //This has 14 brackets, more than single.
							...
							[ 'income' => 5000000, 'rate' => 10.45, 'constant' => 161797 ],
			...
			20150101 => [
					10 => [
							...
							[ 'income' => 1115850, 'rate' => 9.62, 'constant' => 103752 ],
					],
					20 => [
							[ 'income' => 8400, 'rate' => 4.0, 'constant' => 0 ],
							[ 'income' => 11600, 'rate' => 4.5, 'constant' => 336 ],
	...
	function getDistrictAnnualTaxableIncome() {
		...
		$income = TTMath::sub( TTMath::sub( $annual_income, $district_deductions ), $district_allowance );
	...
	function getDistrictAllowanceAmount() {
		...
		if ( $this->getDistrictAllowance() == 0 ) {
			...
			$retval = TTMath::mul( $this->getDistrictAllowance(), $allowance );
		}
	...
	function getDistrictTaxPayable() {
		...
		if ( $annual_income > 0 ) {
			...
			$retval = TTMath::add( TTMath::mul( TTMath::sub( $annual_income, $district_rate_income ), $rate ), $district_constant );
		}
