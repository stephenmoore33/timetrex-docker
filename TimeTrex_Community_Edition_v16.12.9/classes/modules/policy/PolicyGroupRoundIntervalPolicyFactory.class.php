...
class PolicyGroupRoundIntervalPolicyFactory extends Factory {
	...
	function _getSchemadata( ?array $filter = null ): ?TTS {
		...
		if ( empty( $filter ) || in_array( 'database', $filter, true ) ) {
			...
			//				TTSCol::new( 'round_interval_policy_id' )->setFunctionMap( 'RoundIntervalPolicy' )->setType( 'uuid' )->setIsNull( false ),
			...
			//				TTSCol::new( 'is_enabled' )->setFunctionMap( 'IsEnabled' )->setType( 'boolean' )->setIsNull( false ),
