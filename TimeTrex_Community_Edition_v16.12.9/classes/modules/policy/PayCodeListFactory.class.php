 ...
 * @implements IteratorAggregate<PayCodeFactory>
 */
								...
								ELSE
									...
									ELSE
										...
										ELSE
											...
											ELSE
												CASE WHEN EXISTS
													( select 1 from ' . $cgmf->getTable() . ' as w, ' . $cppf->getTable() . ' as v where w.company_id = a.company_id AND w.object_type_id = 90 AND w.map_id = a.id AND w.object_id = v.id AND w.deleted = 0 AND v.deleted = 0 )
												THEN 1
												ELSE
													CASE WHEN EXISTS
