		...
		if ( empty( $filter ) || in_array( 'database', $filter, true ) ) {
			$schema_data->setColumns(
					TTSCols::new(
							...
							TTSCol::new( 'holiday_policy_id' )->setFunctionMap( 'HolidayPolicy' )->setType( 'uuid' )->setIsNull( false ),
							TTSCol::new( 'recurring_holiday_id' )->setFunctionMap( 'RecurringHoliday' )->setType( 'uuid' )->setIsNull( false )
					)
			);
		}
