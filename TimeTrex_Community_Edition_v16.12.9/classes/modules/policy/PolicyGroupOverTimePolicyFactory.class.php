...
class PolicyGroupOverTimePolicyFactory extends Factory {
	...
	function _getSchemadata( ?array $filter = null ): ?TTS {
		...
		if ( empty( $filter ) || in_array( 'database', $filter, true ) ) {
			...
			//				TTSCol::new( 'overtime_policy_id' )->setFunctionMap( 'OverTimePolicy' )->setType( 'uuid' )->setIsNull( false ),
			...
			//				TTSCol::new( 'is_locked' )->setFunctionMap( 'IsLocked' )->setType( 'boolean' )->setIsNull( false ),
