...
class PolicyGroupPremiumPolicyFactory extends Factory {
	...
	function _getSchemadata( ?array $filter = null ): ?TTS {
		...
		if ( empty( $filter ) || in_array( 'database', $filter, true ) ) {
			...
			//				TTSCol::new( 'policy_id' )->setFunctionMap( 'Policy' )->setType( 'uuid' )->setIsNull( false ),
			//				TTSCol::new( 'premium' )->setFunctionMap( 'Premium' )->setType( 'numeric' )->setIsNull( false ),
			//				TTSCol::new( 'effective_date' )->setFunctionMap( 'EffectiveDate' )->setType( 'date' )->setIsNull( false ),
			//				TTSCol::new( 'expiry_date' )->setFunctionMap( 'ExpiryDate' )->setType( 'date' )->setIsNull( false ),
			...
			//				TTSCol::new( 'deleted_at' )->setFunctionMap( 'DeletedAt' )->setType( 'datetime' )->setIsNull( true )
			//		)
			//);
		}
