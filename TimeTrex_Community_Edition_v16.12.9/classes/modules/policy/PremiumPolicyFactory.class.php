...
class PremiumPolicyFactory extends Factory {
	...
	function _getSchemadata( ?array $filter = null ): ?TTS {
		...
		if ( empty( $filter ) || in_array( 'database', $filter, true ) ) {
			$schema_data->setColumns(
					TTSCols::new(
							...
							TTSCol::new( 'start_date' )->setFunctionMap( 'StartDate' )->setType( 'timestamp' ),
							TTSCol::new( 'end_date' )->setFunctionMap( 'EndDate' )->setType( 'timestamp' ),
							TTSCol::new( 'start_time' )->setFunctionMap( 'StartTime' )->setType( 'time' ),
							TTSCol::new( 'end_time' )->setFunctionMap( 'EndTime' )->setType( 'time' ),
							...
							TTSCol::new( 'pay_type_id' )->setFunctionMap( 'PayType' )->setType( 'integer' )->setIsNull( false ),
							TTSCol::new( 'rate' )->setType( 'numeric' )->setIsNull( false ),
							TTSCol::new( 'accrual_policy_id' )->setType( 'uuid' ),
							TTSCol::new( 'accrual_rate' )->setType( 'numeric' ),
							TTSCol::new( 'pay_stub_entry_account_id' )->setType( 'uuid' ),
							TTSCol::new( 'daily_trigger_time' )->setType( 'integer' ),
							TTSCol::new( 'weekly_trigger_time' )->setType( 'integer' ),
							TTSCol::new( 'minimum_time' )->setType( 'integer' ),
							TTSCol::new( 'maximum_time' )->setType( 'integer' ),
							TTSCol::new( 'include_meal_policy' )->setType( 'smallint' ),
							TTSCol::new( 'exclude_default_branch' )->setType( 'smallint' ),
							TTSCol::new( 'exclude_default_department' )->setType( 'smallint' ),
							TTSCol::new( 'branch_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'department_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'job_group_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'job_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'job_item_group_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'job_item_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'maximum_no_break_time' )->setType( 'integer' ),
							TTSCol::new( 'minimum_break_time' )->setType( 'integer' ),
							TTSCol::new( 'include_partial_punch' )->setType( 'smallint' )->setIsNull( false ),
							TTSCol::new( 'wage_group_id' )->setType( 'uuid' )->setIsNull( false ),
							TTSCol::new( 'include_break_policy' )->setType( 'smallint' ),
							TTSCol::new( 'minimum_time_between_shift' )->setType( 'integer' ),
							TTSCol::new( 'minimum_first_shift_time' )->setType( 'integer' ),
							TTSCol::new( 'minimum_shift_time' )->setType( 'integer' ),
							TTSCol::new( 'include_holiday_type_id' )->setType( 'integer' ),
							TTSCol::new( 'maximum_daily_trigger_time' )->setType( 'integer' ),
							TTSCol::new( 'maximum_weekly_trigger_time' )->setType( 'integer' ),
							TTSCol::new( 'pay_code_id' )->setType( 'uuid' ),
							TTSCol::new( 'pay_formula_policy_id' )->setType( 'uuid' ),
							TTSCol::new( 'contributing_shift_policy_id' )->setType( 'uuid' ),
							TTSCol::new( 'exclude_default_job' )->setType( 'smallint' ),
							TTSCol::new( 'exclude_default_job_item' )->setType( 'smallint' ),
							TTSCol::new( 'description' )->setType( 'varchar' ),
							TTSCol::new( 'min_max_time_type_id' )->setFunctionMap( 'MinMaxTimeType' )->setType( 'integer' )->setIsNull( false ),
							TTSCol::new( 'punch_tag_group_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'punch_tag_selection_type_id' )->setType( 'smallint' ),
							TTSCol::new( 'exclude_default_punch_tag' )->setType( 'smallint' ),
		...
		if ( empty( $filter ) || in_array( 'fields', $filter, true ) || in_array( 'api_methods', $filter, true ) ) {
			$schema_data->setTabs(
					TTSTabs::new(
							TTSTab::new( 'tab_premium_policy' )->setLabel( TTi18n::getText( 'Premium Policy' ) )->setFields(
									new TTSFields(
											...
											TTSField::new( 'type_id' )->setType( 'single-dropdown' )->setLabel( TTi18n::getText( 'Type' ) )->setDataSource( TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'getOptions' )->setArg( 'type' ) ),
											TTSField::new( 'minimum_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'Minimum Time' ) ),
											TTSField::new( 'maximum_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'Maximum Time' ) ),
											TTSField::new( 'min_max_time_type_id' )->setType( 'single-dropdown' )->setLabel( TTi18n::getText( 'Min/Max Time Resets' ) )->setDataSource( TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'getOptions' )->setArg( 'min_max_time_type' ) ),
											TTSField::new( 'include_partial_punch' )->setType( 'checkbox' )->setLabel( TTi18n::getText( 'Include Partial Punches' ) ),
							...
							TTSTab::new( 'tab_date_criteria' )->setLabel( TTi18n::getText( 'Date/Time Criteria' ) )->setFields(
									new TTSFields(
											...
											TTSField::new( 'start_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'Start Time' ) ),
											TTSField::new( 'end_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'End Time' ) ),
											TTSField::new( 'include_holiday_type_id' )->setType( 'single-dropdown' )->setLabel( TTi18n::getText( 'Holidays' ) )
									)
							),
							TTSTab::new( 'tab_differential_criteria' )->setLabel( TTi18n::getText( 'Differential Criteria' ) )->setFields(
									new TTSFields(
											//TODO: Add differential criteria fields
									)
							),
							TTSTab::new( 'tab_meal_criteria' )->setLabel( TTi18n::getText( 'Meal/Break Criteria' ) )->setFields(
									new TTSFields(
											TTSField::new( 'daily_trigger_time2' )->setType( 'time' )->setLabel( TTi18n::getText( 'Active After Daily Hours' ) ),
											TTSField::new( 'maximum_no_break_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'Maximum Time Without A Break' ) ),
											TTSField::new( 'minimum_break_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'Minimum Time Recognized As Break' ) )
									)
							),
							TTSTab::new( 'tab_callback_criteria' )->setLabel( TTi18n::getText( 'CallBack Criteria' ) )->setFields(
									new TTSFields(
											TTSField::new( 'minimum_time_between_shift1' )->setType( 'time' )->setLabel( TTi18n::getText( 'Minimum Time Between Shifts' ) ),
											TTSField::new( 'minimum_first_shift_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'First Shift Must Be At Least' ) )
									)
							),
							TTSTab::new( 'tab_minimum_shift_time_criteria' )->setLabel( TTi18n::getText( 'Minimum Shift Time Criteria' ) )->setFields(
									new TTSFields(
											TTSField::new( 'minimum_shift_time' )->setType( 'time' )->setLabel( TTi18n::getText( 'Minimum Shift Time' ) ),
											TTSField::new( 'minimum_time_between_shift2' )->setType( 'time' )->setLabel( TTi18n::getText( 'Minimum Time-Off Between Shifts' ) )
									)
							)
					)->addAudit(),
			);
		...
		if ( empty( $filter ) || in_array( 'api_methods', $filter, true ) ) {
			...
			$schema_data->setAPIMethods(
					TTSAPIs::new(
							TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'getPremiumPolicy' )
									->setSummary( 'Get premium policy records.' )
									->setArgs( [ 'data' => [ 'filter_data' => $schema_data->getSearchFields(), 'filter_columns' => $schema_data->getFields() ] ] )
									->setArgsModelDescription( 'Under the "data" arg there must be at least one or more "filter_data" elements specified, and one or more "filter_columns" elements which define the minimum necessary columns of data to return for carrying out other actions. For example if looking up the "id" of a record, just the "id" filter_columns needs to be specified with a value of true.' ),
							TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'setPremiumPolicy' )
									->setSummary( 'Add or edit premium policy records. Will return the record UUID upon success, or a validation error if there is a problem.' )
									->setArgs( [ 'data' => $schema_data->getFields() ] ),
							TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'deletePremiumPolicy' )
									->setSummary( 'Delete premium policy records by passing in an array of UUIDs.' )
									->setArgs( new TTSFields(
													   TTSField::new( 'data' )->setType( 'multi-dropdown' )->setLabel( TTi18n::getText( 'IDs to Delete' ) )->setDataSource( TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'getPremiumPolicy' ) ),
											   ) ),
							TTSAPI::new( 'APIPremiumPolicy' )->setMethod( 'getPremiumPolicyDefaultData' )
									->setSummary( 'Get default premium policy data used for creating new policies. Use this before calling setPremiumPolicy to get the correct default data.' ),
					),
			);
		}
	...
	*/
	...
	function getPunchTagGroup() {
		return $this->getCompanyGenericMapData( $this->getCompany(), 561, $this->getID(), 'punch_tag_group' );
	}
	...
	function setPunchTagGroup( $ids ) {
		...
		return CompanyGenericMapFactory::setMapIDs( $this->getCompany(), 561, $this->getID(), (array)$ids );
	}
	...
	function getPunchTag() {
		return $this->getCompanyGenericMapData( $this->getCompany(), 562, $this->getID(), 'punch_tag' );
	}
	...
	function setPunchTag( $ids ) {
		...
		return CompanyGenericMapFactory::setMapIDs( $this->getCompany(), 562, $this->getID(), (array)$ids );
	}
	...
	function isActive( $in_epoch, $out_epoch = null, $calculate_policy_obj = null ) {
		...
		while ( $i <= $out_epoch && $last_iteration <= 1 ) {
			...
			if ( ( $this->getIncludeHolidayType() == 10 && $this->isActiveDayOfWeek( $i ) == true && $this->isActiveDate( $i ) == true ) //Check isActiveDayOfWeek() first, as its a more common filter that start/end dates.
					|| ( $this->getIncludeHolidayType() == 20 && ( $is_holiday == true || ( $this->isActiveDayOfWeek( $i ) == true && $this->isActiveDate( $i ) == true ) ) ) //Check is_holiday first, as we already have that variable calculated.
					|| ( $this->getIncludeHolidayType() == 30 && ( $is_holiday == false && ( $this->isActiveDayOfWeek( $i ) == true && $this->isActiveDate( $i ) == true ) ) ) //Check is_holiday first, as we already have that variable calculated.
			) {
			...
			//	$i += 86400;
			if ( TTDate::doesRangeSpanMidnight( $i, $out_epoch ) == true ) { //Use span midnight instead of 86400, as DST transition can cause it to be +/- 3600.
				$i = TTDate::incrementDate( $i, 1, 'day' );
			} else {
	...
	*/
	...
	/**
	 * Return calculation order so premium policies can be calculated in the necessary order.
	 * @return int
	 */
	function getCalculationOrder() {
		switch( $this->getType() ) {
			case 10: //10=Date/Time
			case 100: //100=Advanced (Date/Time+Shift Diff)
				//Convert seconds to hours and cast to integer so we can fit order in 4 digits
				$retval = 10 . ( str_pad( (int)( max( ( $this->getDailyTriggerTime() + $this->getWeeklyTriggerTime() ), 3600 ) / 3600 ), 2, 0, STR_PAD_LEFT ) );
				break;
			case 30: //30=Meal/Break -- Meal/Break policies must be ordered by daily trigger time otherwise they could be in random order and calculate incorrectly.
				$retval = $this->getType() . ( str_pad( (int)( max( $this->getDailyTriggerTime(), 3600 ) / 3600 ), 2, 0, STR_PAD_LEFT ) );
				break;
			case 40: //40=Callback
				$retval = $this->getType() . ( str_pad( (int)( max( $this->getMinimumFirstShiftTime(), 3600 ) / 3600 ), 2, 0, STR_PAD_LEFT ) );
				break;
			case 50: //50=Minimum shift time
				$retval = $this->getType() . ( str_pad( (int)( max( $this->getMinimumShiftTime(), 3600 ) / 3600 ), 2, 0, STR_PAD_LEFT ) );
				break;
			default:
				$retval = 9999;
				break;
	...
	function addLog( $log_action ) {
		return TTLog::addEntry( $this->getId(), $log_action, TTi18n::getText( 'Premium Policy' ) .': '. $this->getName(), null, $this->getTable(), $this );
	}
}
