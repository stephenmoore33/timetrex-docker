 ...
 * @implements IteratorAggregate<UserEducationFactory>
 */
class UserEducationListFactory extends UserEducationFactory implements IteratorAggregate {
	...
	function getAPISearchByCompanyIdAndArrayCriteria( $company_id, $filter_data, $limit = null, $page = null, $where = null, $order = null ) {
		...
		$additional_order_fields = [ 'uf.first_name', 'uf.last_name', 'qf.name', 'qgf.name', 'df.name', 'bf.name', 'ugf.name', 'utf.name' ];
		$sort_column_aliases = [];
		...
		$query .= ( isset( $filter_data['tag'] ) ) ? $this->getWhereClauseSQL( 'a.id', [ 'company_id' => TTUUID::castUUID( $company_id ), 'object_type_id' => 252, 'tag' => $filter_data['tag'] ], 'tag', $ph ) : null;
