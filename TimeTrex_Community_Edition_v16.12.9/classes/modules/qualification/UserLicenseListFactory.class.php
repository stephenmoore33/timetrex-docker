 ...
 * @implements IteratorAggregate<UserLicenseFactory>
 */
class UserLicenseListFactory extends UserLicenseFactory implements IteratorAggregate {
	...
	function getAPISearchByCompanyIdAndArrayCriteria( $company_id, $filter_data, $limit = null, $page = null, $where = null, $order = null ) {
		...
		$additional_order_fields = [ 'first_name', 'last_name', 'qualification', 'qgf.name', 'default_branch', 'default_department', 'user_group', 'title' ];
		...
		$query .= ( isset( $filter_data['tag'] ) ) ? $this->getWhereClauseSQL( 'a.id', [ 'company_id' => TTUUID::castUUID( $company_id ), 'object_type_id' => 253, 'tag' => $filter_data['tag'] ], 'tag', $ph ) : null;
