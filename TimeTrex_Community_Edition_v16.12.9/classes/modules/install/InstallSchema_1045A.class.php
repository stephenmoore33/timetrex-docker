				...
				if ( $c_obj->getStatus() != 30 ) {
					...
					if ( $pclf->getRecordCount() > 0 ) {
						foreach ( $pclf as $pc_obj ) {
							...
							$plf->getByCompanyIdAndPermissionControlIdAndSectionAndNameAndValue( $c_obj->getId(), $pc_obj->getId(), 'absence', [ 'edit', 'edit_own', 'edit_child' ], 1 );
							...
							$plf->getByCompanyIdAndPermissionControlIdAndSectionAndNameAndValue( $c_obj->getId(), $pc_obj->getId(), 'schedule', [ 'edit', 'edit_own', 'edit_child' ], 1 );
							if ( $plf->getRecordCount() > 0 ) {
