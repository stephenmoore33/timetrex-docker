...
class PermissionUserFactory extends Factory {
	...
	function postSave() {
		if ( is_object( $this->getUserObject() ) ) {
			$this->removeCache( $this->getUserObject()->getCompany() . $this->getUser() ); //Used in PermissionControlListFactory::getByCompanyIdAndUserId()
		}
	...
	function postDelete() {
		if ( is_object( $this->getUserObject() ) ) {
			//Since we often delete the record completely, we need to make sure caching is kept up to date here too.
			$this->removeCache( $this->getUserObject()->getCompany() . $this->getUser() ); //Used in PermissionControlListFactory::getByCompanyIdAndUserId()
		}
