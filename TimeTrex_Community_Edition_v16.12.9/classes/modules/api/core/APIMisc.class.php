...
class APIMisc extends APIFactory {
	...
	function generateQRCode( $data ) {
		$barcode_obj = new TCPDF2DBarcode( $data, 'QRCODE' );
		$barcode_html = 'data:image/x-icon;base64,' . base64_encode( $barcode_obj->getBarcodePngData() );

		return $this->returnHandler( $barcode_html );
	}
}
