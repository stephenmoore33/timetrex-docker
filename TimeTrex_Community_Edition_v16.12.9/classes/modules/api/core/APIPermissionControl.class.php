...
class APIPermissionControl extends APIFactory {
	...
	function getOptions( $name = false, $parent = null ) {
		if ( $name == 'columns'
				&& ( !$this->getPermissionObject()->Check( 'permission', 'enabled' )
						|| !( $this->getPermissionObject()->Check( 'permission', 'view' ) || $this->getPermissionObject()->Check( 'permission', 'view_own' ) || $this->getPermissionObject()->Check( 'permission', 'view_child' ) ) ) ) {
			$name = 'list_columns';
		}
	...
	function setPermissionControl( $data, $validate_only = false, $ignore_warning = true ) {
		...
		if ( !$this->getPermissionObject()->Check( 'permission', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'permission', 'edit' ) || $this->getPermissionObject()->Check( 'permission', 'edit_own' ) || $this->getPermissionObject()->Check( 'permission', 'edit_child' ) || $this->getPermissionObject()->Check( 'permission', 'add' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if (
								...
								(
										...
										|| ( $this->getPermissionObject()->Check( 'permission', 'edit_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true )
								) ) {
	...
	function deletePermissionControl( $data ) {
		...
		if ( !$this->getPermissionObject()->Check( 'permission', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'permission', 'delete' ) || $this->getPermissionObject()->Check( 'permission', 'delete_own' ) || $this->getPermissionObject()->Check( 'permission', 'delete_child' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
				...
				if ( $id != '' ) {
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if ( $this->getPermissionObject()->Check( 'permission', 'delete' )
								|| ( $this->getPermissionObject()->Check( 'permission', 'delete_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true ) ) {
	...
	function copyPermissionControl( $data ) {
		...
		$src_rows = $this->stripReturnHandler( $this->getPermissionControl( [ 'filter_data' => [ 'id' => $data ] ], true ) );
