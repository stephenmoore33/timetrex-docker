...
class APIContributingPayCodePolicy extends APIFactory {
	...
	function getOptions( $name = false, $parent = null ) {
		if ( $name == 'columns'
				&& ( !$this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'enabled' )
						|| !( $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'view' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'view_own' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'view_child' ) ) ) ) {
			$name = 'list_columns';
		}
	...
	function setContributingPayCodePolicy( $data, $validate_only = false, $ignore_warning = true ) {
		...
		if ( !$this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'edit' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'edit_own' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'edit_child' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'add' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if (
								...
								(
										...
										|| ( $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'edit_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true )
								) ) {
	...
	function deleteContributingPayCodePolicy( $data ) {
		...
		if ( !$this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'delete' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'delete_own' ) || $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'delete_child' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
				...
				if ( $id != '' ) {
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if ( $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'delete' )
								|| ( $this->getPermissionObject()->Check( 'contributing_pay_code_policy', 'delete_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true ) ) {
	...
	function copyContributingPayCodePolicy( $data ) {
		...
		$src_rows = $this->stripReturnHandler( $this->getContributingPayCodePolicy( [ 'filter_data' => [ 'id' => $data ] ], true ) );
