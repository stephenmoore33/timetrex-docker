...
class APIRegularTimePolicy extends APIFactory {
	...
	function getOptions( $name = false, $parent = null ) {
		if ( $name == 'columns'
				&& ( !$this->getPermissionObject()->Check( 'regular_time_policy', 'enabled' )
						|| !( $this->getPermissionObject()->Check( 'regular_time_policy', 'view' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'view_own' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'view_child' ) ) ) ) {
			$name = 'list_columns';
		}
	...
	function setRegularTimePolicy( $data, $validate_only = false, $ignore_warning = true ) {
		...
		if ( !$this->getPermissionObject()->Check( 'regular_time_policy', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'regular_time_policy', 'edit' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'edit_own' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'edit_child' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'add' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if (
								...
								(
										...
										|| ( $this->getPermissionObject()->Check( 'regular_time_policy', 'edit_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true )
								) ) {
	...
	function deleteRegularTimePolicy( $data ) {
		...
		if ( !$this->getPermissionObject()->Check( 'regular_time_policy', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'regular_time_policy', 'delete' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'delete_own' ) || $this->getPermissionObject()->Check( 'regular_time_policy', 'delete_child' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
				...
				if ( $id != '' ) {
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if ( $this->getPermissionObject()->Check( 'regular_time_policy', 'delete' )
								|| ( $this->getPermissionObject()->Check( 'regular_time_policy', 'delete_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true ) ) {
	...
	function copyRegularTimePolicy( $data ) {
		...
		$src_rows = $this->stripReturnHandler( $this->getRegularTimePolicy( [ 'filter_data' => [ 'id' => $data ] ], true ) );
