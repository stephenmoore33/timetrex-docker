...
class APISchedulePolicy extends APIFactory {
	...
	function getOptions( $name = false, $parent = null ) {
		if ( $name == 'columns'
				&& ( !$this->getPermissionObject()->Check( 'schedule_policy', 'enabled' )
						|| !( $this->getPermissionObject()->Check( 'schedule_policy', 'view' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'view_own' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'view_child' ) ) ) ) {
			$name = 'list_columns';
		}
	...
	function setSchedulePolicy( $data, $validate_only = false, $ignore_warning = true ) {
		...
		if ( !$this->getPermissionObject()->Check( 'schedule_policy', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'schedule_policy', 'edit' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'edit_own' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'edit_child' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'add' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if (
								...
								(
										...
										|| ( $this->getPermissionObject()->Check( 'schedule_policy', 'edit_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true )
								) ) {
	...
	function deleteSchedulePolicy( $data ) {
		...
		if ( !$this->getPermissionObject()->Check( 'schedule_policy', 'enabled' )
				|| !( $this->getPermissionObject()->Check( 'schedule_policy', 'delete' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'delete_own' ) || $this->getPermissionObject()->Check( 'schedule_policy', 'delete_child' ) ) ) {
			return $this->getPermissionObject()->PermissionDenied();
		}
				...
				if ( $id != '' ) {
					...
					if ( $lf->getRecordCount() == 1 ) {
						...
						if ( $this->getPermissionObject()->Check( 'schedule_policy', 'delete' )
								|| ( $this->getPermissionObject()->Check( 'schedule_policy', 'delete_own' ) && $this->getPermissionObject()->isOwner( $lf->getCurrent()->getCreatedBy(), $lf->getCurrent()->getID() ) === true ) ) {
	...
	function copySchedulePolicy( $data ) {
		...
		$src_rows = $this->stripReturnHandler( $this->getSchedulePolicy( [ 'filter_data' => [ 'id' => $data ] ], true ) );
