...
class APIHoliday extends APIFactory {
	...
	function getHoliday( $data = null, $disable_paging = false ) {
		...
		if ( !( $this->getPermissionObject()->Check( 'holiday_policy', 'enabled' ) || $this->getPermissionObject()->Check( 'schedule', 'enabled' ) )
	...
	function copyHoliday( $data ) {
		...
		$src_rows = $this->stripReturnHandler( $this->getHoliday( [ 'filter_data' => [ 'id' => $data ] ], true ) );
