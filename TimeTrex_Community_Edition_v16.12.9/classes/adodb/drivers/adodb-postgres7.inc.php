...
class ADORecordSet_postgres7 extends ADORecordSet_postgres64{
	...
	function MoveNext()
	{
		if (!$this->EOF) {
			...
			//$this->fields = false; //Causes a bug with Factory->serializeRS(), as we iterate over the RS there to cache it, then attempt to do it again immediately after, but the fields are false.
			$this->EOF = true;
		}
		return false;
	}
