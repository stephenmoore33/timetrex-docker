...
/**
 * @group USPayrollDeductionTest2024
 */
class USPayrollDeductionTest2024 extends PHPUnit\Framework\TestCase {
	...
	public function setUp(): void {
		...
		$this->tax_table_file = dirname( __FILE__ ) . '/USPayrollDeductionTest2024.csv';
		...
		foreach ( $test_rows as $row ) {
			...
			if ( $row['country'] != '' && $row['gross_income'] != '' ) {
				...
				if ( $row['provincial_deduction'] != '' ) {
					...
					if ( !in_array( $row['province'], [ '00', 'CT', 'MD', 'MT', 'OR', 'IA', 'ME', 'GA', 'OH', 'KS' ] ) && $amount_diff > 5 ) { //Some states had significant changes.
	...
	function testUS_2024_Test2019W4() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '2038.90', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_TestAdditionalDeductionExcessA() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1273.69', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_TestAdditionalDeductionExcessB() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '2000.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '863.69', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Would be 174.42 without the additional deduction. Test max out of additional deduction at highest tax rate plus buffer.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_TestAdditionalDeductionExcessC() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '253.85', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Would be 11.73 without the additional deduction. Test max out of additional deduction at highest tax rate plus buffer.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_TestAdditionalDeductionExcessD() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024_Test2020W4AdditionalDeductionWithLowIncome() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024_Test2020W4AdditionalDeductionWithHighIncome() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2048.90', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //2227.24
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_Test2020W4AdditionalDeductionWithHighIncomeAndNonPeriodic() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024_Test2020W4SingleJob1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2038.90', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //2228.90
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_Test2020W4TwoJobs1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2697.26', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_Test2020W4OneJobWithDependents1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '1942.74', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_Test2020W4OneJobWithOtherIncome1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2163.89', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_Test2020W4OneJobWithDeductions1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '1977.36', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_Test2020W4OneJobWithAdditionalDeduction1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2038.90', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //2128.90 + 100
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2020W4WageBracket1a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '154.69', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 214 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2020W4WageBracket1b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '154.69', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 166 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2020W4WageBracket2a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '361.41', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 395 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2020W4WageBracket2b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '266.60', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 291 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2020W4WageBracket2c() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '328.28', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 362 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2020W4WageBracket3a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '203.13', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 236 based on 2024 W4 standard withholding tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2019W4WageBracket1a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '184.46', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 212 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2019W4WageBracket1b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '164.62', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 177 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2024_Test2019W4WageBracket2a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	//Examples from 15-T publication.
	function testUS_2024_Test2019W4WageBracket2b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	//Examples from 15-T publication.
	function testUS_2024_Test2019W4WageBracket2c() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	//Examples from 15-T publication.
	function testUS_2024_Test2019W4WageBracket3a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '239.52', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 236 based on 2024 W4 standard withholding tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_ID_2024a_Test1() {
		...
		$this->assertEquals( '9.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_ID_2024a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_LA_2024a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_LA_2024a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_Test1() {
		...
		$this->assertEquals( '34.62', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '36.21', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
		$this->assertEquals( '35.77', $this->mf( $pd_obj->getEmployeeSocialSecurity() ) );
	}

	function testUS_AR_2024a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '38.16', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) ); //Should be 56.83, but they round a lot.
	}

	function testUS_AR_2024a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '342.72', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}
	function testUS_IA_2024a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$pd_obj->setStateFilingStatus( 10 ); //Single
		$pd_obj->setStateAllowance( 120 ); //Exemption Claimed Amount
		...
		$pd_obj->setGrossPayPeriodIncome( 2100 );

		$this->assertEquals( '2100.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '41.99', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_MS_2024a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '67.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) ); //80.85
	}

	function testUS_MS_2024a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1890.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '34.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) ); //46.23
	}

	//
	// US Social Security
	//
	function testUS_2024a_SocialSecurity() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_SocialSecurity_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_Medicare() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_Additional_MedicareA() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_Additional_MedicareB() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_Additional_MedicareC() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_Additional_MedicareD() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_FederalUI_NoState() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_FederalUI_NoState_CustomRate() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_FederalUI_NoState_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_FederalUI_State_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_StateUI_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_RI_2024_StateUI_WageBase() { //Variable wage base limits depending on experience rate.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '29200', $pd_obj->getStateUIWageBase() );

		$pd_obj->setStateUIRate( 9.69 );
		$this->assertEquals( '29200', $pd_obj->getStateUIWageBase() );

		$pd_obj->setStateUIRate( 9.70 );
		$this->assertEquals( '30700', $pd_obj->getStateUIWageBase() );

		$pd_obj->setStateUIRate( 15.00 );
		$this->assertEquals( '30700', $pd_obj->getStateUIWageBase() );
	}

	function testUS_NE_2024_StateUI_WageBase() { //Variable wage base limits depending on experience rate.
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2024a_State_UI_WageBase() {
		$cf = new CompanyFactory();
		$provinces = $cf->getOptions('province', 'US');
		if ( !empty($provinces) ) {
			asort( $provinces );
	...
	function testUS_2024_MD1() {
		...
		$this->assertEquals( '272.86', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_MD2() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '8880.61', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_MD3() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '8730.77', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$pd_obj->setStateFilingStatus( 20 ); //Married (Married spouse has no income)
		...
		$this->assertEquals( '41.43', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS2A() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '100.50', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS2B() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '80.84', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS2C() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '75.86', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS2D() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '70.88', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS2E() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '65.91', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS3A() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$pd_obj->setStateFilingStatus( 20 ); //Married Joint
		$pd_obj->setStateAllowance( 0 );
		...
		$pd_obj->setGrossPayPeriodIncome( 2030 );

		$this->assertEquals( '89.08', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS3B() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '70.76', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS3C() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '52.44', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS3D() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '47.80', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2024_KS3E() {
		Debug::text( 'US - SemiMonthly - Beginning of 2024 01-Jan-2024: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '43.16', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}
}
