...
/**
 * @group CAPayrollDeductionTest2023
 */
class CAPayrollDeductionTest2023 extends PHPUnit\Framework\TestCase {
	...
	public function setUp(): void {
		...
		$this->tax_table_file = dirname( __FILE__ ) . '/CAPayrollDeductionTest2023.csv';
			...
			if ( $row['country'] != '' && $row['gross_income'] != '' ) {
				...
				if ( $row['federal_deduction'] != '' ) {
					...
					if ( $amount_diff > 5.5 ) {
						...
						$this->assertLessThan( 11.0, $amount_diff_percent ); //Should be slightly higher than inflation.
						$this->assertGreaterThanOrEqual( 0, $amount_diff_percent );
					}
				}
				if ( $row['provincial_deduction'] != '' ) {
					...
					if ( $row['province'] != 'AB' && $amount_diff > 5.50 ) { //2023 year AB was made too large of change.
						$this->assertLessThan( 26, $amount_diff_percent, $i . '. Amount: This Year: ' . $row['provincial_deduction'] . ' Last Year: ' . $pd_obj->getProvincialPayPeriodDeductions() . ' Diff Amount: ' . $amount_diff . ' Percent: ' . $amount_diff_percent . '%' ); //Reasonable margin of error.
	...
	function testCA_2023a_Example() {
		Debug::text( 'CA - Example Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '66.90', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '61.67', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_Example1() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '75.26', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '11.55', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_Example2() {
		Debug::text( 'CA - Example2 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '238.04', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '132.59', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_Example3() {
		Debug::text( 'CA - Example3 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '415.25', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '199.24', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_Example4() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '123.03', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '50.04', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_Example5() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1741.70', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '875.07', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_Example6() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '8300.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '1736.16', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '874.87', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_NS_Example1() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '19.93', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '16.30', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_NS_Example2() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '259.89', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '170.32', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_NS_Example3() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '2217.89', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '1615.74', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_GovExample1() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '96.17', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '55.20', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_GovExample2() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1030.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '96.17', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '40.48', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_GovExample3() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1030.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '96.17', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '51.32', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_GovExample4() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1030.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '96.17', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '87.28', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	//
	// CPP/ EI
	//
	function testCA_2023a_BiWeekly_CPP_LowIncome() {
		Debug::text( 'CA - BiWeekly - CPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2023a_SemiMonthly_CPP_LowIncome() {
		Debug::text( 'CA - BiWeekly - CPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2023a_SemiMonthly_MAXCPP_LowIncome() {
		Debug::text( 'CA - BiWeekly - MAXCPP - Beginning of 2023 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2023a_EI_LowIncome() {
		Debug::text( 'CA - EI - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2023a_MAXEI_LowIncome() {
		Debug::text( 'CA - MAXEI - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2023a_MAXEI_MAXCPPa() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );

		$pd_obj = new PayrollDeduction( 'CA', 'BC' );
		$pd_obj->setDate( strtotime( '10-Nov-2023' ) );
		$pd_obj->setEnableCPPAndEIDeduction( true ); //Deduct CPP/EI.
		$pd_obj->setAnnualPayPeriods( 26 );
		...
		$this->assertEquals( '290.58', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '118.26', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPa2() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );

		$pd_obj = new PayrollDeduction( 'CA', 'AB' );
		$pd_obj->setDate( strtotime( '04-Nov-2023' ) );
		$pd_obj->setEnableCPPAndEIDeduction( true ); //Deduct CPP/EI.
		$pd_obj->setAnnualPayPeriods( 26 );
		...
		$this->assertEquals( '300.01', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should match the same federal amount in the below function.
		$this->assertEquals( '162.44', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPa3() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
...
//		$pd_obj->setEmployeeEIForPayPeriod( 14.30 );
		...
		$this->assertEquals( '304.37', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should match the same federal amount in the above function.
		$this->assertEquals( '164.56', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPb() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '294.88', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '119.88', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPc() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1.00', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '1.40', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '295.53', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '120.12', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPd() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '295.57', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '120.14', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPe() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '356.28', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '142.94', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPf() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '46.71', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '65.39', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '355.72', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '142.73', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_MAXEI_MAXCPPf2() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2023a_MAXEI_MAXCPPg() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '170.17', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '69.29', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2023a_RRSP() {
		Debug::text( 'CA - RRSP Contribution - Beginning of 01-Jan-2023: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '125.98', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '68.47', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}
}
