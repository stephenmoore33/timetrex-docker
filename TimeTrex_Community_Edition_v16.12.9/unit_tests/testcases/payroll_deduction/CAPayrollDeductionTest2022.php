...
/**
 * @group CAPayrollDeductionTest2022
 */
class CAPayrollDeductionTest2022 extends PHPUnit\Framework\TestCase {
	...
	public function setUp(): void {
		...
		$this->tax_table_file = dirname( __FILE__ ) . '/CAPayrollDeductionTest2022.csv';
			...
			if ( $row['country'] != '' && $row['gross_income'] != '' ) {
				...
				if ( $row['federal_deduction'] != '' ) {
					...
					if ( $amount_diff > 5.5 ) {
						...
						$this->assertLessThan( 10.0, $amount_diff_percent ); //Should be slightly higher than inflation.
						$this->assertGreaterThanOrEqual( 0, $amount_diff_percent );
					}
				}
				if ( $row['provincial_deduction'] != '' ) {
	...
	function testCA_2022a_Example() {
		Debug::text( 'CA - Example Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '71.52', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '65.13', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_Example1() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '56.78', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '7.15', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_Example2() {
		Debug::text( 'CA - Example2 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '250.85', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '139.53', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_Example3() {
		Debug::text( 'CA - Example3 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '432.64', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '204.19', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_Example4() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '127.63', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '51.58', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_Example5() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1801.53', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '916.32', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_NS_Example1() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '20.43', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '16.32', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_NS_Example2() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '261.18', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '172.00', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_NS_Example3() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '2300.64', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '1634.54', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_GovExample1() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '102.14', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '58.64', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_GovExample2() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1030.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '102.14', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '42.85', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_GovExample3() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1030.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '102.14', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '54.93', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_GovExample4() {
		Debug::text( 'CA - Example1 - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1030.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '102.14', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '89.37', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	//
	// CPP/ EI
	//
	function testCA_2022a_BiWeekly_CPP_LowIncome() {
		Debug::text( 'CA - BiWeekly - CPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '25.69', $this->mf( $pd_obj->getEmployeeCPP() ) );
		$this->assertEquals( '25.69', $this->mf( $pd_obj->getEmployerCPP() ) );
	}

	function testCA_2022a_SemiMonthly_CPP_LowIncome() {
		Debug::text( 'CA - BiWeekly - CPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '25.05', $this->mf( $pd_obj->getEmployeeCPP() ) );
		$this->assertEquals( '25.05', $this->mf( $pd_obj->getEmployerCPP() ) );
	}

	function testCA_2022a_SemiMonthly_MAXCPP_LowIncome() {
		Debug::text( 'CA - BiWeekly - MAXCPP - Beginning of 2022 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_EI_LowIncome() {
		Debug::text( 'CA - EI - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_LowIncome() {
		Debug::text( 'CA - MAXEI - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_MAXCPPa() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );

		$pd_obj = new PayrollDeduction( 'CA', 'BC' );
		$pd_obj->setDate( strtotime( '10-Nov-2022' ) );
		$pd_obj->setEnableCPPAndEIDeduction( true ); //Deduct CPP/EI.
		$pd_obj->setAnnualPayPeriods( 26 );
		...
		$this->assertEquals( '138.77', $this->mf( $pd_obj->getEmployeeCPP() ) );
		$this->assertEquals( '138.77', $this->mf( $pd_obj->getEmployerCPP() ) );
		$this->assertEquals( '40.59', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '56.83', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '304.32', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '123.44', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_MAXEI_MAXCPPa2() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );

		$pd_obj = new PayrollDeduction( 'CA', 'AB' );
		$pd_obj->setDate( strtotime( '04-Nov-2022' ) );
		$pd_obj->setEnableCPPAndEIDeduction( true ); //Deduct CPP/EI.
		$pd_obj->setAnnualPayPeriods( 26 );
		...
		$this->assertEquals( '313.11', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should match the same federal amount in the below function.
		$this->assertEquals( '169.59', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_MAXEI_MAXCPPa3() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
...
//		$pd_obj->setEmployeeEIForPayPeriod( 14.30 );
		...
		$this->assertEquals( '313.11', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should match the same federal amount in the above function.
		$this->assertEquals( '169.59', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_MAXEI_MAXCPPb() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_MAXCPPc() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_MAXCPPd() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_MAXCPPe() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '365.03', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '146.24', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_MAXEI_MAXCPPf() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_MAXCPPf2() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testCA_2022a_MAXEI_MAXCPPg() {
		Debug::text( 'CA - MAXEI/MAXCPP - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '100.63', $this->mf( $pd_obj->getEmployeeCPP() ) );
		$this->assertEquals( '100.63', $this->mf( $pd_obj->getEmployerCPP() ) );
		$this->assertEquals( '30.02', $this->mf( $pd_obj->getEmployeeEI() ) );
		$this->assertEquals( '42.03', $this->mf( $pd_obj->getEmployerEI() ) );
		$this->assertEquals( '174.91', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '73.96', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}

	function testCA_2022a_RRSP() {
		Debug::text( 'CA - RRSP Contribution - Beginning of 01-Jan-2022: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '129.92', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '69.87', $this->mf( $pd_obj->getProvincialPayPeriodDeductions() ) );
	}
}
