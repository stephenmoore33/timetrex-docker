...
/**
 * @group USPayrollDeductionTest2021
 */
class USPayrollDeductionTest2021 extends PHPUnit\Framework\TestCase {
	...
	public function setUp(): void {
		...
		$this->tax_table_file = dirname( __FILE__ ) . '/USPayrollDeductionTest2021.csv';
		...
		foreach ( $test_rows as $row ) {
			...
			if ( $row['country'] != '' && $row['gross_income'] != '' ) {
				...
				if ( $row['provincial_deduction'] != '' ) {
					...
					if ( !in_array( $row['province'], [ '00', 'AR', 'OR', 'ND', 'NM', 'NY' ] ) && $amount_diff > 5 ) { //Some states had significant changes.
	...
	function testTaxBracketConstants() { //Double checks to make sure there isn't an error in the tax brackets or constants.
		...
		if ( !empty($provinces) ) {
			...
			foreach( $provinces as $province => $province_name ) {
				if ( in_array( $province, [ 'AR', 'NC', 'SC', 'UT' ] ) ) { // States with non-standard tax brackets.
					continue;
				}
				...
				foreach( $filing_status_arr as $filing_status ) {
					...
					foreach( $new_pd_obj->income_tax_rates as $region_name => $region_tax_brackets ) {
						...
						foreach( $region_tax_brackets as $key => $tax_bracket ) {
							...
							$this->assertEqualsWithDelta( $tax_bracket['constant'], $cumulative_constant, 2.00, 'State: '. $province .' Filing Status: '. $filing_status .' Bracket: '. $key );
	...
	function testUS_2021_Test2019W4() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '2217.24', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_TestAdditionalDeductionExcessA() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1284.42', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_TestAdditionalDeductionExcessB() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '2000.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '874.42', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Would be 174.42 without the additional deduction. Test max out of additional deduction at highest tax rate plus buffer.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_TestAdditionalDeductionExcessC() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '261.73', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Would be 11.73 without the additional deduction. Test max out of additional deduction at highest tax rate plus buffer.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_TestAdditionalDeductionExcessD() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021_Test2020W4AdditionalDeductionWithLowIncome() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021_Test2020W4AdditionalDeductionWithHighIncome() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2227.24', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //2227.24
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_Test2020W4AdditionalDeductionWithHighIncomeAndNonPeriodic() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021_Test2020W4SingleJob1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2217.24', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //2228.90
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_Test2020W4TwoJobs1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2791.24', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_Test2020W4OneJobWithDependents1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2121.09', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_Test2020W4OneJobWithOtherIncome1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2351.86', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_Test2020W4OneJobWithDeductions1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2149.93', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_2021_Test2020W4OneJobWithAdditionalDeduction1() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '9615.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '2217.24', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //2128.90 + 100
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2020W4WageBracket1a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '165.42', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 214 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2020W4WageBracket1b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '165.42', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 166 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2020W4WageBracket2a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '393.03', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 395 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2020W4WageBracket2b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '289.10', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 291 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2020W4WageBracket2c() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '359.86', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 362 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2020W4WageBracket3a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '234.27', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 236 based on 2021 W4 standard withholding tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2019W4WageBracket1a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '208.37', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 212 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2019W4WageBracket1b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '175.35', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 177 based on tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	//Examples from 15-T publication.
	function testUS_2021_Test2019W4WageBracket2a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	//Examples from 15-T publication.
	function testUS_2021_Test2019W4WageBracket2b() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	//Examples from 15-T publication.
	function testUS_2021_Test2019W4WageBracket2c() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	//Examples from 15-T publication.
	function testUS_2021_Test2019W4WageBracket3a() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '1925.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '272.02', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) ); //Should be about 236 based on 2021 W4 standard withholding tax tables.
		$this->assertEquals( '0.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_ID_2021a_Test1() {
	...
	function testUS_ID_2021a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_LA_2021a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_LA_2021a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_Test1() {
		...
		$this->assertEquals( '43.35', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '37.09', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
		$this->assertEquals( '35.77', $this->mf( $pd_obj->getEmployeeSocialSecurity() ) );
	}

	function testUS_AR_2021a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '56.71', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) ); //Should be 56.83, but they round a lot.
	}

	function testUS_AR_2021a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
		...
		$this->assertEquals( '455.87', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}

	function testUS_MS_2021a_Test1() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_MS_2021a_Test2() {
		//Example from employer guide.
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	// US Social Security
	//
	function testUS_2021a_SocialSecurity() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_SocialSecurity_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_Medicare() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_Additional_MedicareA() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_Additional_MedicareB() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_Additional_MedicareC() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_Additional_MedicareD() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_FederalUI_NoState() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_FederalUI_NoState_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
	...
	function testUS_2021a_FederalUI_State_Max() {
		Debug::text( 'US - SemiMonthly - Beginning of 2021 01-Jan-2021: ', __FILE__, __LINE__, __METHOD__, 10 );
