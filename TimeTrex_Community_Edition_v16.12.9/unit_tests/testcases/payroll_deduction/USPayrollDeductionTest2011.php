...
class USPayrollDeductionTest2011 extends PHPUnit\Framework\TestCase {
	...
	function testUS_2011a_SocialSecurity() {
		...
		$this->assertEquals( '42.00', $this->mf( $pd_obj->getEmployeeSocialSecurity() ) );
	}
	...
	function testMD_2011a_BiWeekly_Single_LowIncome() {
		...
		$this->assertEquals( '1000.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '121.54', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '55.38', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}
	...
	function testMD_2011a_BiWeekly_Married_LowIncome() {
		...
		$this->assertEquals( '1000.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '55.38', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '48.00', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}
	...
	function testMD_2011a_BiWeekly_Married_HighIncome() {
		...
		$this->assertEquals( '804.81', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '280.62', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}
	...
	function testMD_2011b_BiWeekly_Married_HighIncome() {
		...
		$this->assertEquals( '5000.00', $this->mf( $pd_obj->getGrossPayPeriodIncome() ) );
		$this->assertEquals( '804.81', $this->mf( $pd_obj->getFederalPayPeriodDeductions() ) );
		$this->assertEquals( '371.82', $this->mf( $pd_obj->getStatePayPeriodDeductions() ) );
	}
	/*
