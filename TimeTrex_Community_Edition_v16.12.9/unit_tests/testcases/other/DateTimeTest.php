...
class DateTimeTest extends PHPUnit\Framework\TestCase {
	...
	function testTimeUnit1() {
		...
		*/
		...
		$this->assertEquals( 3601.5, TTDate::parseTimeUnit( '1:00:01.5' ) );
		$this->assertEquals( 3660, TTDate::parseTimeUnit( '1:1.5' ) );

		//Bad formatting examples that shouldn't cause errors.
		$this->assertEquals( 3600, TTDate::parseTimeUnit( '01:' ) );
		$this->assertEquals( 3660, TTDate::parseTimeUnit( '01:01:' ) );
		$this->assertEquals( 3662, TTDate::parseTimeUnit( '01:01:02.' ) );
		$this->assertEquals( 3662, TTDate::parseTimeUnit( '01:01:02.Z' ) );
		...
		$this->assertEquals( 3600.001, TTDate::parseTimeUnit( '3600.001' ) ); //Always allow decimals with seconds.
		$this->assertEquals( 3600.001, TTDate::parseTimeUnit( '"3600.001"' ) );
		//$this->assertEquals( 3629, TTDate::parseTimeUnit( '3629.001' ) );
		$this->assertEquals( 3629.001, TTDate::parseTimeUnit( '3629.001' ) ); //Always allow decimals with seconds.
	...
	function testTimeUnit4() {
		...
		*/
		...
		$this->assertEquals( '5124095576030431:00', TTDate::getTimeUnit( TTMath::add( PHP_INT_MAX, PHP_INT_MAX ) ) );
		$this->assertEquals( '5124095576030431:11', TTDate::getTimeUnit( TTMath::add( TTMath::add( PHP_INT_MAX, PHP_INT_MAX ), 660 ) ) );
		...
		$this->assertEquals( '-5124095576030431:00', TTDate::getTimeUnit( TTMath::mul( TTMath::add( PHP_INT_MAX, PHP_INT_MAX ), -1 ) ) );
		...
		$this->assertEquals( '9223372036854775807:00:49', TTDate::getTimeUnit( TTMath::add( TTMath::mul( PHP_INT_MAX, PHP_INT_MAX ), '0.99999' ) ) );
		$this->assertEquals( '9223372036854775807:00:49', TTDate::getTimeUnit( TTMath::add( TTMath::mul( PHP_INT_MAX, PHP_INT_MAX ), '0.00001' ) ) ); // (float)0.00001 gets converted to scientific notation when casted to string, resulting in bcadd() throwing a non-well formed argument error.
		...
		$this->assertEquals( '-1000000:11:00', TTDate::getTimeUnit( -3600000660 ) );
		//$this->assertEquals( TTDate::getTimeUnit( ( ( PHP_INT_MAX + PHP_INT_MAX ) * -1 ) ), 		'ERR(FLOAT)' );
		$this->assertEquals( '-5124095576030431:00:14', TTDate::getTimeUnit( TTMath::mul( TTMath::add( PHP_INT_MAX, PHP_INT_MAX ), -1 ) ) );

		$this->assertEquals( '-9223372036854775807:00:49', TTDate::getTimeUnit( TTMath::mul( TTMath::mul( PHP_INT_MAX, PHP_INT_MAX ), -1 ) ) );

		$this->assertEquals( '01:01:01', TTDate::getTimeUnit( 3661.0 ) );
		$this->assertEquals( '01:01:01', TTDate::getTimeUnit( '3661.0000000' ) );
		$this->assertEquals( '01:01:01.1', TTDate::getTimeUnit( 3661.1 ) );
		$this->assertEquals( '01:01:01.123456', TTDate::getTimeUnit( 3661.123456 ) );
		$this->assertEquals( '01:01:01.9', TTDate::getTimeUnit( 3661.9 ) );
		$this->assertEquals( '01:01:01.99', TTDate::getTimeUnit( 3661.99 ) );
		$this->assertEquals( '-01:01:01', TTDate::getTimeUnit( -3661.0 ) );
		$this->assertEquals( '-01:01:01.1', TTDate::getTimeUnit( -3661.1 ) );
		$this->assertEquals( '-01:01:01.123456', TTDate::getTimeUnit( -3661.123456 ) );
		$this->assertEquals( '-01:01:01.9', TTDate::getTimeUnit( -3661.9 ) );
		...
		$this->assertEquals( '5,124,095,576,030,431.0000', TTDate::getTimeUnit( TTMath::add( PHP_INT_MAX, PHP_INT_MAX ) ) );
		$this->assertEquals( '5,124,095,576,030,431.0000', TTDate::getTimeUnit( TTMath::add( TTMath::add( PHP_INT_MAX, PHP_INT_MAX ), 660 ) ) );
	...
	function testTime1() {
		...
		//Obvious typo fixes...
		$this->assertEquals( 1109390940, TTDate::parseDateTime( '2005-02-25 8;09PM' ) ); //Test with semi-colon, to ensure it gets converted to a colon.
		$this->assertEquals( 1109390940, TTDate::parseDateTime( '2005-02-25 8?09PM' ) ); //Test with '?', to ensure it gets converted to a colon.
		$this->assertEquals( 1109390940, TTDate::parseDateTime( '2005=02-25 8;09PM' ) ); //Test with '=' instead of '-'
		$this->assertEquals( 1109390940, TTDate::parseDateTime( '2005+02-25 8;09PM' ) ); //Test with '+' instead of '-'
		$this->assertEquals( 1109390940, TTDate::parseDateTime( '2005+02-25 8\'09PM' ) ); //Test with '\'' instead of '-'
		$this->assertEquals( 1109390940, TTDate::parseDateTime( '2005+02_25 8"09PM' ) ); //Test with '"' instead of '-'
	}
	...
	function test_roundTime() {
		...
		$this->assertEquals( 3661, TTDate::parseTimeUnit( '01:01:01.0', 12 ) );
		$this->assertEquals( 3661.1, TTDate::parseTimeUnit( '01:01:01.1', 12 ) );
		$this->assertEquals( 3661.123456, TTDate::parseTimeUnit( '01:01:01.123456', 12 ) );
		$this->assertEquals( 3661.99, TTDate::parseTimeUnit( '01:01:01.99', 12 ) );
	...
	function test_getNearestWeekDay() {
		...
		//Test mixing getBeginDayEpoch() and getMiddleDayEpoch()
		$this->assertEquals( TTDate::getNearestWeekDay( strtotime( '16-Jan-2010 12:00PM' ), 3, [ TTDate::getBeginDayEpoch( strtotime( '15-Jan-2010' ) ) ] ), strtotime( '14-Jan-2010 12:00PM' ) );
		$this->assertEquals( TTDate::getNearestWeekDay( strtotime( '16-Jan-2010 12:00AM' ), 3, [ TTDate::getMiddleDayEpoch( strtotime( '15-Jan-2010' ) ) ] ), strtotime( '14-Jan-2010 12:00AM' ) );
	}
	...
	function test_getTimeStamp() {
		...
		$this->assertEquals( '01-Jan-23 12:30:30 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeStamp( 2023, 1, 1, 12, 30, 30 ) ) );
		$this->assertEquals( '01-Jan-70 12:30:30 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeStamp( 1970, 1, 1, 12, 30, 30 ) ) );
		$this->assertEquals( '01-Jan-10 12:30:30 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeStamp( 1910, 1, 1, 12, 30, 30 ) ) );
	}
	...
	function test_inApplyFrequencyWindow() {
		...
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 30, strtotime( '29-Jan-2010' ), strtotime( '12-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 30, strtotime( '30-Jan-2010' ), strtotime( '12-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 30, strtotime( '31-Jan-2010' ), strtotime( '12-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 30, strtotime( '01-Feb-2010' ), strtotime( '12-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 30, strtotime( '30-Jan-2010' ), strtotime( '28-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 30, strtotime( '01-Feb-2010' ), strtotime( '28-Feb-2010' ), $frequency_criteria ) );
		...
		//No range
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '10-Feb-2010' ), strtotime( '10-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '10-Mar-2010' ), strtotime( '10-Mar-2010' ), $frequency_criteria ) );

		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '27-Feb-2010' ), strtotime( '27-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '28-Feb-2010' ), strtotime( '28-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '01-Mar-2010' ), strtotime( '01-Mar-2010' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '27-Feb-2011' ), strtotime( '27-Feb-2011' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '28-Feb-2011' ), strtotime( '28-Feb-2011' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '01-Mar-2011' ), strtotime( '01-Mar-2011' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '28-Feb-2012' ), strtotime( '28-Feb-2012' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '29-Feb-2012' ), strtotime( '29-Feb-2012' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '01-Mar-2012' ), strtotime( '01-Mar-2012' ), $frequency_criteria ) );

		//Range
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '01-Feb-2010' ), strtotime( '10-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( false, TTDate::inApplyFrequencyWindow( 35, strtotime( '11-Feb-2010' ), strtotime( '27-Feb-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '28-Feb-2010' ), strtotime( '05-Mar-2010' ), $frequency_criteria ) );
		$this->assertEquals( true, TTDate::inApplyFrequencyWindow( 35, strtotime( '22-Feb-2010' ), strtotime( '28-Feb-2010' ), $frequency_criteria ) );
	...
	function testInvalidTimeZone() {
		$this->assertEquals( false, TTDate::setTimeZone( 'Etc/GMT+9999' ) );
		$this->assertEquals( true, TTDate::setTimeZone( 'UTC' ) );
		$this->assertEquals( true, TTDate::setTimeZone( 'America/Vancouver' ) );
	}
	...
	function testTimeZones() {
		...
		foreach ( $zones as $zone => $name ) {
			...
			//Check to make sure PHP's timezone offset matches the databases timezone offset.
			$timestamp_str = TTDate::getYear().'-01-01 12:00:00';
			$php_tz_offset_seconds = TTDate::getTimeZoneObject( Misc::trimSortPrefix( $zone ), true )->getOffset( new DateTime( $timestamp_str ) );
			$db_tz_offset_seconds = $db->GetOne( 'select ( extract( timezone from \''. $timestamp_str .'\'::timestamp with time zone ) )' );
			$this->assertEquals( $php_tz_offset_seconds, $db_tz_offset_seconds, 'PHP and DB TZ Mismatch: ' . $name .' PHP: '. $php_tz_offset_seconds .' DB: '. $db_tz_offset_seconds );

			$timestamp_str = TTDate::getYear().'-06-01 12:00:00';
			$php_tz_offset_seconds = TTDate::getTimeZoneObject( Misc::trimSortPrefix( $zone ), true )->getOffset( new DateTime( $timestamp_str ) );
			$db_tz_offset_seconds = $db->GetOne( 'select ( extract( timezone from \''. $timestamp_str .'\'::timestamp with time zone ) )' );
			$this->assertEquals( $php_tz_offset_seconds, $db_tz_offset_seconds, 'PHP and DB TZ Mismatch: ' . $name .' PHP: '. $php_tz_offset_seconds .' DB: '. $db_tz_offset_seconds );
		}

		//Get PHP list and diff with it to see if we are missing any time zones that should be added.
		$tt_tz_list = Misc::trimSortPrefix( array_keys( $zones ) );
		$php_tz_list = timezone_identifiers_list();
		$tz_list_diff = array_diff( $php_tz_list, $tt_tz_list );
		$this->assertEquals( 0, count( $tz_list_diff ), 'PHP supports more time zones than us: '. implode( ', ', $tz_list_diff ) );
		if ( count( $tz_list_diff ) > 0 ) {
			print_r( $tz_list_diff );
		}
	}
	...
	function testDeprecatedTimeZones() {
		...
		foreach( $countries as $country ) {
			...
			foreach ( $zones as $deprecated_zone => $new_zone ) {
				...
				$this->assertEquals( $deprecated_time, $new_time, 'Depcreated Zone: ' . $deprecated_zone . ' New Zone: ' . $new_zone .' Diff: '. ( $new_time - $deprecated_time ) );
			}
		}
	}
			...
			foreach ( $location_zones as $country => $zone_arr ) {
				if ( is_array( $zone_arr ) ) {
					foreach ( $zone_arr as $zone ) {
						...
						foreach( $zone as $tmp_zone ) {
							if ( isset( $deprecated_zones[$tmp_zone] ) ) {
								$this->assertTrue( false, 'Location TimeZone Map: Zone is deprecated: ' . $tmp_zone . ' Should be: ' . $deprecated_zones[$tmp_zone] );
							}

							//Make sure detected timezone are actually valid and in the main timezone list.
							if ( $tmp_zone != '' && !isset( $zones[$tmp_zone] ) ) {
								$this->assertTrue( false, 'Area Code TimeZone Map: Zone is does not exist in main Time Zone list: ' . $tmp_zone );
							}
						}
					}
				} else {
	...
	function testSplitDateRange() {
		...
		//https://www.php.net/manual/en/datetime.settime.php - v8.1.0	The behaviour with double existing hours (during the fall-back DST transition) changed. Previously PHP would pick the second occurrence (after the DST transition), instead of the first occurrence (before DST transition).
		if ( version_compare( PHP_VERSION, '8.1.0', '>=' ) ) {
			//the missing hour shows up in the filter
			$split_range_arr = TTDate::splitDateRangeAtMidnight( strtotime( '5-Nov-2016 8:00AM PDT' ), ( strtotime( '6-Nov-2016 1:00AM PDT' ) + 7200 ), strtotime( '6-Nov-2016 8:00AM PDT' ), strtotime( '6-Nov-2016 1:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[0]['start_time_stamp'], strtotime( '5-Nov-2016 8:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[0]['end_time_stamp'], strtotime( '6-Nov-2016 12:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[1]['start_time_stamp'], strtotime( '6-Nov-2016 12:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[1]['end_time_stamp'], strtotime( '6-Nov-2016 1:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[2]['start_time_stamp'], strtotime( '6-Nov-2016 1:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[2]['end_time_stamp'], strtotime( '6-Nov-2016 2:00AM PST' ) );
			$this->assertCount( 3, $split_range_arr );

			//fall daylight savings. illustrating the missing hour
			$split_range_arr = TTDate::splitDateRangeAtMidnight( strtotime( '5-Nov-2016 8:00AM PDT' ), ( strtotime( '6-Nov-2016 1:00AM PDT' ) + 7200 ), strtotime( '6-Nov-2016 8:00AM PDT' ), ( strtotime( '6-Nov-2016 1:00AM PDT' ) + 3600 ) );
			$this->assertEquals( $split_range_arr[0]['start_time_stamp'], strtotime( '05-Nov-2016 8:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[0]['end_time_stamp'], strtotime( '06-Nov-2016 12:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[1]['start_time_stamp'], strtotime( '06-Nov-2016 12:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[1]['end_time_stamp'], strtotime( '06-Nov-2016 1:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[2]['start_time_stamp'], strtotime( '06-Nov-2016 1:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[2]['end_time_stamp'], strtotime( '06-Nov-2016 2:00AM PST' ) );
			$this->assertCount( 3, $split_range_arr );

			$split_range_arr = TTDate::splitDateRangeAtMidnight( strtotime( '4-Nov-2023 6:45PM PDT' ), strtotime( '5-Nov-2023 6:45AM PST' ), strtotime( '5-Nov-2023 12:45AM PDT' ), strtotime( '5-Nov-2023 1:15AM PDT' ) );
			$this->assertEquals( $split_range_arr[0]['start_time_stamp'], strtotime( '4-Nov-2023 6:45PM PDT' ) );
			$this->assertEquals( $split_range_arr[0]['end_time_stamp'], strtotime( '5-Nov-2023 12:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[1]['start_time_stamp'], strtotime( '5-Nov-2023 12:00AM PDT' ) );
			$this->assertEquals( $split_range_arr[1]['end_time_stamp'], strtotime( '5-Nov-2023 12:45AM PDT' ) );
			$this->assertEquals( $split_range_arr[2]['start_time_stamp'], strtotime( '5-Nov-2023 12:45AM PDT' ) );
			$this->assertEquals( $split_range_arr[2]['end_time_stamp'], strtotime( '5-Nov-2023 1:15AM PDT' ) );
			$this->assertEquals( $split_range_arr[3]['start_time_stamp'], strtotime( '5-Nov-2023 1:15AM PDT' ) );
			$this->assertEquals( $split_range_arr[3]['end_time_stamp'], strtotime( '5-Nov-2023 6:45AM PST' ) );
			$this->assertCount( 4, $split_range_arr );
		} else {
			//the missing hour shows up in the filter
		...
		$split_range_arr = TTDate::splitDateRangeAtMidnight( strtotime('29-Aug-23 1:00 PM'), strtotime('29-Aug-23 3:15 PM'), strtotime('29-Aug-23 7:00 AM'), strtotime('29-Aug-23 3:00PM') );
		$this->assertEquals( $split_range_arr[0]['start_time_stamp'], strtotime( '29-Aug-23 1:00 PM' ) );
		$this->assertEquals( $split_range_arr[0]['end_time_stamp'], strtotime( '29-Aug-23 3:00 PM' ) );
		$this->assertEquals( $split_range_arr[1]['start_time_stamp'], strtotime( '29-Aug-23 3:00 PM' ) );
		$this->assertEquals( $split_range_arr[1]['end_time_stamp'], strtotime( '29-Aug-23 3:15 PM' ) );
		$this->assertCount( 2, $split_range_arr );
	}
	...
	function testIncrementDate() {
		...
		//Accrual Policy milestones often use 0.25, 0.50 or 0.75 years, so we need to make sure those continue work as expected.
		$this->assertEquals( TTDate::incrementDate( strtotime( '02-Nov-2020 12:00:00 PM' ), 0.5, 'year' ), strtotime( '02-May-2021 12:00:00 PM' ) );
		$this->assertEquals( TTDate::incrementDate( strtotime( '02-Nov-2020 12:00:00 PM' ), -0.5, 'year' ), strtotime( '02-May-2020 12:00:00 PM' ) );
		$this->assertEquals( TTDate::incrementDate( strtotime( '02-Nov-2020 12:00:00 PM' ), 0.25, 'year' ), strtotime( '02-Feb-2021 12:00:00 PM' ) );
		$this->assertEquals( TTDate::incrementDate( strtotime( '02-Nov-2020 12:00:00 PM' ), 0.999, 'year' ), strtotime( '01-Nov-2021 03:21:35 AM' ) );
	}
	...
	function testLocationTimeZone() {
		...
		$this->assertEquals( 'America/New_York', $upf->getLocationTimeZone( 'US', 'FL' ) ); //Same state with different timezones based on phone number.
		...
		$this->assertEquals( 'America/New_York', $upf->getLocationTimeZone( 'US', 'FL', '8505555555' ) );  //Same state with different timezones based on phone number.
		$this->assertEquals( 'America/Chicago', $upf->getLocationTimeZone( 'US', 'FL', '8505555555', null, 'America/Chicago' ) );  //Same state with different timezones based on phone number.
		$this->assertEquals( 'America/Los_Angeles', $upf->getLocationTimeZone( 'US', 'FL', '8505555555', null, 'America/Los_Angeles' ) );  //Test forcing to a default timezone.
		...
		$this->assertEquals( 'America/Chicago', $upf->getLocationTimeZone( 'US', 'NE', '3085555555', null, 'America/Chicago' ) );
		$this->assertEquals( 'America/Denver', $upf->getLocationTimeZone( 'US', 'NE', '3085555555', null, 'America/Denver' ) );
	}
	...
	function testcountDayOfWeekInRange() {
		$this->assertEquals( 4, TTDate::countDayOfWeekInRange( strtotime('01-Dec-22'), strtotime('31-Dec-22'), 0  ) ); //0=Sunday
		$this->assertEquals( 5, TTDate::countDayOfWeekInRange( strtotime('01-Dec-22'), strtotime('31-Dec-22'), 4  ) ); //4-Thusday
	}

	function testConvertSecondsToHMS() {
		$this->assertEquals( '01:01', TTDate::convertSecondsToHMS( 3661, false ) );
		$this->assertEquals( '01:01', TTDate::convertSecondsToHMS( 3661.4, false ) );
		$this->assertEquals( '01:01', TTDate::convertSecondsToHMS( 3661.5, false ) );
		$this->assertEquals( '01:01', TTDate::convertSecondsToHMS( 3719, false ) );
		$this->assertEquals( '01:02', TTDate::convertSecondsToHMS( 3720, false ) );
		$this->assertEquals( '01:01:01', TTDate::convertSecondsToHMS( 3661, true ) );
		$this->assertEquals( '01:01:01.4', TTDate::convertSecondsToHMS( 3661.4, true ) );
		$this->assertEquals( '01:01:01.5', TTDate::convertSecondsToHMS( 3661.5, true ) );
		$this->assertEquals( '01:01:59', TTDate::convertSecondsToHMS( 3719, true ) );
		$this->assertEquals( '01:02:00', TTDate::convertSecondsToHMS( 3720, true ) );

		$this->assertEquals( '596523:14:07', TTDate::convertSecondsToHMS( 2147483647, true ) ); //32-bit maximum integer.
		$this->assertEquals( '2562047788015215:28:40', TTDate::convertSecondsToHMS( 9223372036854775000, true ) ); //Slightly lower than 64-bit maximum integer.
		$this->assertEquals( '2562047788015215:28:07', TTDate::convertSecondsToHMS( PHP_INT_MAX, true ) ); //64-bit maximum integer.
		$this->assertEquals( '2562047788015215:28:07', TTDate::convertSecondsToHMS( (string)PHP_INT_MAX, true ) ); //64-bit maximum integer.
		$this->assertEquals( '2562047788015215:33:19', TTDate::convertSecondsToHMS( '9223372036854775999', true ) ); //Larger than 64-bit maximum integer in string format.

		$this->assertEquals( '00:00:02.3283064365', TTDate::convertSecondsToHMS( 2.3283064365387, true ) );
		$this->assertEquals( '00:00:02.3283064365', TTDate::convertSecondsToHMS( 2.3283064365387123456789, true ) );

		$this->assertEquals( '00:00:00', TTDate::convertSecondsToHMS( 0, true ) );
		$this->assertEquals( '00:00:00', TTDate::convertSecondsToHMS( '2.3283064365387...', true ) );
		$this->assertEquals( '00:00:00', TTDate::convertSecondsToHMS( null, true ) );
		$this->assertEquals( '00:00:00', TTDate::convertSecondsToHMS( '', true ) );
		$this->assertEquals( '00:00:00', TTDate::convertSecondsToHMS( 'abc', true ) );
	}

	function testBeginMiddleEndDayEpoch() {
		TTDate::setDateFormat( 'd-M-Y' );
		TTDate::setTimeFormat( 'g:i:s A' );

		$this->assertEquals( '01-Jan-2023 12:00:00 AM', TTDate::getDate( 'DATE+TIME', TTDate::getBeginDayEpoch( strtotime( '2023-01-01 11:00AM PST' ) ) ) );
		$this->assertEquals( '01-Jan-2023 12:00:00 AM', TTDate::getDate( 'DATE+TIME', TTDate::getBeginDayEpoch( strtotime( '2023-01-01 12:00AM PST' ) ) ) );

		$this->assertEquals( '01-Jan-2023 12:00:00 PM', TTDate::getDate( 'DATE+TIME', TTDate::getMiddleDayEpoch( strtotime( '2023-01-01 11:00AM PST' ) ) ) );
		$this->assertEquals( '01-Jan-2023 12:00:00 PM', TTDate::getDate( 'DATE+TIME', TTDate::getMiddleDayEpoch( strtotime( '2023-01-01 12:00PM PST' ) ) ) );

		$this->assertEquals( '01-Jan-2023 11:59:59 PM', TTDate::getDate( 'DATE+TIME', TTDate::getEndDayEpoch( strtotime( '2023-01-01 11:00AM PST' ) ) ) );
		$this->assertEquals( '01-Jan-2023 11:59:59 PM', TTDate::getDate( 'DATE+TIME', TTDate::getEndDayEpoch( strtotime( '2023-01-01 11:59:59PM PST' ) ) ) );
	}

	function testTimeLockedDate() {
		TTDate::setDateFormat( 'd-M-Y' );
		TTDate::setTimeFormat( 'g:i:s A T' );

		TTDate::setTimeZone( 'America/Vancouver' );

		$this->assertEquals( '01-Jun-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2023-06-01 00:00:00 PDT') ) ) );
		$this->assertEquals( '01-Jun-1980 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('1980-06-01 00:00:00 PDT') ) ) );
		$this->assertEquals( '01-Jun-2001 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2001-06-01 00:00:00 PDT') ) ) );
		$this->assertEquals( '01-Jun-2035 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2035-06-01 00:00:00 PDT') ) ) );

		$this->assertEquals( '01-Jun-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2023-06-01 01:00:00 PDT') ) ) );
		$this->assertEquals( '01-Jun-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2023-06-01 07:00:00 PDT') ) ) );


		$this->assertEquals( '01-Jun-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2023-06-01 22:00:00 PDT') ) ) );
		$this->assertEquals( '01-Jun-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-06-05 15:16:17 PDT'), strtotime('2023-06-01 22:00:00 PDT') ) ) );

		$this->assertEquals( '05-Nov-2023 2:16:17 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-11-05 15:16:17 PDT'), strtotime('2023-11-05 01:00:00 PDT') ) ) );
		$this->assertEquals( '05-Nov-2023 2:16:17 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-11-05 15:16:17 PDT'), strtotime('2023-11-05 07:00:00 PDT') ) ) );
		$this->assertEquals( '05-Nov-2023 2:16:17 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-11-05 15:16:17 PDT'), strtotime('2023-11-05 22:00:00 PDT') ) ) );

		$this->assertEquals( '12-Mar-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 15:16:17 PDT'), strtotime('2023-03-12 01:00:00 PDT') ) ) );
		$this->assertEquals( '12-Mar-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 15:16:17 PDT'), strtotime('2023-03-12 07:00:00 PDT') ) ) );
		$this->assertEquals( '12-Mar-2023 3:16:17 PM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 15:16:17 PDT'), strtotime('2023-03-12 22:00:00 PDT') ) ) );


		$this->assertEquals( '01-Jan-2016 7:00:00 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2016-01-01 19:00:00 PST'), strtotime('2016-01-01 09:00:00 PST') ) ) );
		$this->assertEquals( '01-Jan-2016 6:00:00 PM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2016-01-01 19:00:00 PDT'), strtotime('2016-01-01 09:00:00 PDT') ) ) );



		$this->assertEquals( '05-Nov-2023 1:15:00 AM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-11-05 01:15:00 PDT'), strtotime('2023-11-05 00:00:00 PDT') ) ) );
		$this->assertEquals( '05-Nov-2023 1:15:00 AM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-11-05 01:15:00 PST'), strtotime('2023-11-05 00:00:00 PDT') ) ) );
		$this->assertEquals( '05-Nov-2023 1:15:00 AM PDT', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-11-05 01:15:00 PDT'), strtotime('2023-11-05 00:00:00 PST') ) ) );


		$this->assertEquals( '12-Mar-2023 12:15:00 AM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 01:15:00 PDT'), strtotime('2023-03-12 00:00:00 PST') ) ) );
		$this->assertEquals( '12-Mar-2023 1:15:00 AM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 01:15:00 PST'), strtotime('2023-03-12 00:00:00 PST') ) ) );
		$this->assertEquals( '11-Mar-2023 12:15:00 AM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 01:15:00 PDT'), strtotime('2023-03-12 00:00:00 PDT') ) ) ); //PDT gets converted to PST and that bumps it onto the previous day.
		$this->assertEquals( '12-Mar-2023 12:15:00 AM PST', TTDate::getDate( 'DATE+TIME', TTDate::getTimeLockedDate( strtotime('2023-03-12 01:15:00 PDT'), strtotime('2023-03-12 12:00:00 PDT') ) ) );
	}

	function testSpansDST() {
		TTDate::setTimeZone( 'America/Vancouver' );
		...
		//$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 1:00:00 AM PST' ), strtotime( '12-Mar-2023 1:55:00 AM PST' ) ) );
		//$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 1:00:00 AM PST' ), strtotime( '12-Mar-2023 1:59:59 AM PST' ) ) );
		//$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 1:00:00 AM PST' ), strtotime( '12-Mar-2023 2:00:00 AM PST' ) ) );
		//$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 1:00:00 AM PST' ), strtotime( '12-Mar-2023 2:00:01 AM PST' ) ) );
		//$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 1:00:00 AM PST' ), strtotime( '12-Mar-2023 3:00:01 AM PST' ) ) );
		//$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 2:00:00 AM PST' ), strtotime( '12-Mar-2023 3:00:01 AM PST' ) ) );
		//$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '12-Mar-2023 2:00:00 AM PDT' ), strtotime( '12-Mar-2023 3:00:01 AM PST' ) ) );


		//Make sure 01-Jan at 1:15AM isn't mistakenly considered a DST transition, due to  how isTimeOverlapsDSTTransition() works. See comments in it.
		$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '01-Jan-2024 1:15:00 AM' ), strtotime( '01-Jan-2024 1:30:00 AM' ) ) );
		$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '01-Jan-2024 2:15:00 AM' ), strtotime( '01-Jan-2024 2:30:00 AM' ) ) );

		//
		//Fall - 2AM -> 1AM
		//
		$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:00:00 AM' ), strtotime( '05-Nov-2023 12:55:00 AM' ) ) );
		$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 12:59:59 AM PDT' ) ) );
		//$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PST' ), strtotime( '05-Nov-2023 12:59:59 AM PST' ) ) ); //This one doesn't make much sense, since PST doesn't exist before 1AM.

		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:00:00 AM PDT' ) ) );
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:15:00 AM PST' ) ) );
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:45:00 AM PST' ) ) );
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:45:00 AM PDT' ) ) );
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:45:00 AM PDT' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) );
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:45:00 AM PST' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) ); //This must be TRUE.
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:59:59 AM PST' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) ); //This must be TRUE.
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:59:59 AM PDT' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) ); //This must be TRUE.
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:15:00 AM PDT' ), strtotime( '05-Nov-2023 2:00:00 AM PST' ) ) ); //This must be TRUE.
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:15:00 AM PST' ), strtotime( '05-Nov-2023 2:00:00 AM PST' ) ) ); //This must be TRUE.
		$this->assertEquals( true, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 2:00:00 AM PDT' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) ); //This must be TRUE, since in PDT we have not passed the DST transition yet.

		$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 2:00:00 AM PST' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) ); //This must be FALSE, since we have fully passed the DST transition.
		$this->assertEquals( false, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 2:00:01 AM PST' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ) ) );


		//Check with returning offset
		$this->assertEquals( 0, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:00:00 AM PDT' ), strtotime( '05-Nov-2023 12:55:00 AM PDT' ), true ) );
		$this->assertEquals( 0, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:00:00 AM PDT' ), true ) );
		$this->assertEquals( -900, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:15:00 AM PDT' ), true ) );
		$this->assertEquals( -2700, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:45:00 AM PDT' ), strtotime( '05-Nov-2023 1:45:00 AM PDT' ), true ) );
		$this->assertEquals( -2700, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:00:00 AM PDT' ), strtotime( '05-Nov-2023 1:45:00 AM PDT' ), true ) );
		$this->assertEquals( -2700, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:15:00 AM PDT' ), strtotime( '05-Nov-2023 1:45:00 AM PDT' ), true ) );
		$this->assertEquals( 4500, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:45:00 AM PDT' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ), true ) ); //Because its 1:45AM PDT, it needs to add 1.25hrs to get start time after 2AM PST, or subtract 1.25hrs to get end time before 1AM PDT
		$this->assertEquals( 4500, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:45:00 AM PDT' ), strtotime( '05-Nov-2023 2:45:00 AM PST' ), true ) ); //Becuse 1:45AM PDT is 1.25hrs from 2AM PST and 2:45AM PST is 2.75hrs from 1AM PDT.
		$this->assertEquals( 6300, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:15:00 AM PDT' ), strtotime( '05-Nov-2023 2:15:00 AM PST' ), true ) );
		$this->assertEquals( -3600, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:00:00 AM PDT' ), strtotime( '05-Nov-2023 2:00:00 AM PDT' ), true ) );
		$this->assertEquals( -3600, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:00:00 AM PDT' ), strtotime( '05-Nov-2023 2:00:00 AM PST' ), true ) );
		$this->assertEquals( -3600, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:00:00 AM PDT' ), strtotime( '05-Nov-2023 2:00:00 AM PST' ), true ) );

		$this->assertEquals( -3600, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:00:00 AM PST' ), strtotime( '05-Nov-2023 2:00:00 AM PST' ), true ) );
		$this->assertEquals( 1800, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:30:00 AM PST' ), strtotime( '05-Nov-2023 2:30:00 AM PST' ), true ) );
		$this->assertEquals( 900, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:45:00 AM PST' ), strtotime( '05-Nov-2023 2:30:00 AM PST' ), true ) );
		$this->assertEquals( 1, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 1:59:59 AM PST' ), strtotime( '05-Nov-2023 2:30:00 AM PST' ), true ) );
		$this->assertEquals( 0, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 2:00:00 AM PST' ), strtotime( '05-Nov-2023 2:30:00 AM PST' ), true ) );
		$this->assertEquals( 0, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 2:15:00 AM PST' ), strtotime( '05-Nov-2023 2:30:00 AM PST' ), true ) );

		$this->assertEquals( 0, TTDate::isTimeOverlapsDSTTransition( strtotime( '05-Nov-2023 12:15:00 AM PDT' ), strtotime( '05-Nov-2023 2:30:00 AM PST' ), true ) );
